...
They could modify the file AND change the filename, but:
...
The badge shows automatically. Just glance at the corner:
- Green? Good! 🟢
- Yellow? Be careful 🟡
- Red? Don't trust! 🔴
...
When you save changes, the file will get a new filename with a new fingerprint. That's normal. The old version and new version will have different fingerprints.
